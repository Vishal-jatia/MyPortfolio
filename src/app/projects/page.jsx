    ...
    <main className={`min-h-screen ${inter.variable} my-10 mx-2`}>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        >
          ...
          <div className="pt-10 border-t mb-5 mx-4 border-dotted flex flex-row justify-between items-center md:items-end">
            ...
            <Image
              ...
              width={70}
              height={70}
              className="mr-5 bg-gray-700 border bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-50 rounded-full p-2 scale-75 md:scale-100"
            />
          </div>
        </motion.div>
        {projects.map((project) => {
          return (
            <motion.div
              ...
              key={project.key}
              className="font-inter border rounded-3xl p-5 group/all flex flex-col justify-between h-full"
            >
              <div>
